...
// router.createNewUser = (req, res) => {
// 	const requiredFields = ['email', 'password', 'passwordConf'];
// 	const optionalFields = ['clubName', 'location', 'clubWebsite'];
// 	let _newUser;
...
// 	.catch(err => res.status(500).json({message: 'Internal server error from user-router'}))
// });
